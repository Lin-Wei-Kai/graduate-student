<%-- 
    Document   : recommend
    Created on : 2015/1/2, 下午 07:57:33
    Author     : lin
--%>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <p class="text-center">國防大學管理學院碩士學位論文</p>
                                    <p class="text-center">指導教授推薦書</p>
                                    <p class="text-center">__________碩士班_______君所提之論文</p>
                                    <p class="text-center">________________(題目)</p>
                                    <p class="text-center">係由本人指導撰述，同意提付審查。</p>
                                </table>
                            </div>
                        </div>
                    </div>
