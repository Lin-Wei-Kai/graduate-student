<%-- 
    Document   : teacher_index
    Created on : 2014/12/2, 上午 10:51:23
    Author     : lin
--%>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href=""><i class="fa fa-file fa-3x"></i> 學生論文計畫書</a>
                    </li>
		    <li>
                        <a  href="#"><i class="fa fa-folder fa-3x"></i> 論文初稿及加分</a>
                        <ul class="nav nav-second-level">
                            <li><a  href="ex_person.jsp"><i class="fa fa-eye fa-2x"></i> 加分審核</a></li>
